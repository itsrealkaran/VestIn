...
export default function DevProfilePage() {
  ...
  const profile = {
    ...
    bio: "Experienced investor with a passion for supporting innovative software ventures that drive technological progress. With a strong background in tech and business, I specialize in identifying and funding startups with scalable solutions in areas such as SaaS, AI, Web3, and cloud technologies. I seek out teams with visionary leadership, solid product-market fit, and the potential for high growth. My investment philosophy centers on empowering entrepreneurs who are pushing the boundaries of software development to create sustainable, long-term value.",
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="w-full max-w-4xl mx-auto">
        ...
        <CardContent className="space-y-6">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4">Funded Projects</h2>
